//This is a gliffy modified version of TinyMCE.  Make sure to just do a straight replace of tinyMCE

//Uncomment this to test tinyMCE loading later than it should due to network traffic
//GLIFFY_TEST_MCE_LATE_LOAD = true;
...
tinymce.util.Quirks = function(editor) {
    ...
    function bodyHeight() {
        editor.contentStyles.push('body {min-height: 14px}');
    ...
    function fix(original_event, data) {
        ...
        for (name in original_event) {
            ...
            if (name !== "layerX" && name !== "layerY") {
                // handle deprecated events in Chrome
                if (name === "keyLocation" && original_event.location !== undefined) {
                    name = "location";
                } else if (name === "webkitMovementX" && original_event.movementX !== undefined) {
                    name = "movementX";
                } else if (name === "webkitMovementY" && original_event.movementY !== undefined) {
                    name = "movementY";
                }
...
(function(tinymce) {
    ...
    tinymce.create('tinymce.dom.DOMUtils', {
        ...
        setStyle : function(n, na, v) {
            ...
            //evil no good rocco hack for EDITOR-1702.  Spent way too long trying to find the root cause.
            //only occurs on chrome win7, but also tested safari, & mac chrome.
            if (tinymce.isWebKit &&
                n && n.id === 'menu_gliffy-edit-text_gliffy-edit-text_fontsizeselect_menu_co' &&
                na === 'width'){
                v = 80
            }
    ...
    tinymce.create('tinymce.dom.Selection', {
        ...
        setContent : function(content, args) {
            ...
            if (rng.insertNode) {
                ...
                // GLIFFY WAS HERE - modified to check if it matched the documentElement
                if (rng.startContainer == doc.documentElement && rng.endContainer == doc.documentElement) {
                    // WebKit will fail if the body is empty since the range is then invalid and it can't insert contents
                    doc.body.innerHTML = content;
                } else {
                    rng.deleteContents();

                    if (doc.body && doc.body.childNodes && doc.body.childNodes.length === 0) {
                        doc.body.innerHTML = content;
                    } else {
        ...
        getRng : function(w3c) {
            var self = this, selection, rng, elm, doc = self.win.document, condition = false;
            ...
            try{
                condition = (
                    tinymce.isIE &&
                        ...
                        rng &&
                        rng.setStart &&
                        doc.selection.createRange().item !== undefined &&
                        doc.selection.createRange().item !== null);
            } catch (ex){
                condition = false;
            }
            ...
            if (!t.tridentSel) {
                ...
                if (s) {
                    ...
                    try {
                        ...
                        //
                        // GLIFFY MOD - in IE9, this was throwing an unspecified error.  It was below try/catch, but we moved
                        // it back in the try.  Haven't seen bad things happend yet.  - cd & rb
                        s.addRange(r);
                    } catch (ex) {
                        // IE9 might throw errors here don't know why
                        // //console.log('ie9 exception');
                    }
    ...
    tinymce.dom.Serializer = function(settings, dom, schema) {
        ...
        return {
            ...
            serialize : function(node, args) {
                ...
                if(node) { //Gliffy MOD BUGFIX-EDITOR-2423
    ...
    tinymce.create('tinymce.ui.KeyboardNavigation', {
        KeyboardNavigation: function(settings, dom) {
            ...
            t.moveFocus = function(dir, evt) {
                ...
                //gliffy mod: protect against JS errors with nullchecks
                //todo: proper handling of arrow keys in this dialog
                if (dom !== null)
...
(function(tinymce) {
    ...
    tinymce.create('tinymce.ui.DropMenu:tinymce.ui.Menu', {
        ...
        renderNode : function() {
            ...
            w = DOM.create('div', {role: 'listbox', id : 'menu_' + t.id, 'class' : s['class'], 'style' : 'position:absolute;left:0;top:0;z-index:580000;outline:0'});
    ...
    tinymce.create('tinymce.ui.ListBox:tinymce.ui.Control', {
        ...
        renderMenu : function() {
            ...
            m.add({
                ...
                onclick : function() {
                    //gliffy mod: don't allow 'font size' and 'font family' to be selected
    ...
    tinymce.create('tinymce.Editor', {
        ...
        initContentBody : function() {
            ...
            self.onExecCommand.add(function(editor, command) {
                ...
                if (tinyMCE.isIE9){
                    //Gliffy: IE9 inserts line breaks around our bookmark when nodeChanged is called causing EDITOR-1437
                    if (!/^(FontName|FontSize|gliffyLink)$/.test(command)) {
                        self.nodeChanged();
                    }
                }
                else{
            ...
            if (e.altKey || e.ctrlKey || e.metaKey) {
                each(self.shortcuts, function(shortcut) {
                    ...
                    if (e.keyCode == shortcut.keyCode || (e.charCode && e.charCode == shortcut.charCode)) {
                        ...
                        //Gliffy mod: prevent browser default on meta-y (mac)
                        if(shortcut.scope && shortcut.scope.length > 0 && shortcut.scope[0] === 'ctrl+y'){
                            return false
                        }
...
(function(tinymce) {
    ...
    tinymce.EditorCommands = function(editor) {
        ...
        function applyFormat(name, value) { //new
            formatter.apply(name, value ? {value : value} : undef);
        };
        ...
        addCommands({
            ...
            'ForeColorOn' : function(command, ui, value) {
...
(function(tinymce) {
    ...
    tinymce.UndoManager = function(editor) {
        var self, index = 0, data = [], beforeBookmark, onAdd, onUndo, onRedo, onCantUndo;
        ...
        onCantUndo  = new Dispatcher(self);

        // Pass though onAdd event from UndoManager to Editor as onChange
        onAdd.add(function(undoman, level) {
            //GLIFFY Mod: remove the hasUndo check to fix EDITOR-1082
            //  will there be side effects?  who knows.
        ...
        onCantUndo.add(function(undoman, level) {
            return editor.onCantUndo.dispatch(editor, level, undoman);
        });
        ...
        //Gliffy mod: add shortcut keys
        editor.addShortcut('ctrl+shift+z', 'redo_desc', 'Redo');
        ...
        self = {
            ...
            undo : function() {
                ...
                if (index > 0) {
                    ...
                    self.onCantUndo.dispatch(self, level);
                }
...
tinymce.ForceBlocks = function(editor) {
    ...
    function addRootBlocks() {
        ...
        node = rootNode && rootNode.firstChild;
        while (node) {
    ...
    tinymce.Formatter = function(ed) {
        ...
        function expandRng(rng, format, remove) {
            ...
            if (endContainer.nodeType == 1 && endContainer.hasChildNodes()) {
                ...
                var nodeIdx = endOffset > lastIdx ? lastIdx : endOffset - 1;
                if(nodeIdx >= 0){
                    endContainer = endContainer.childNodes[nodeIdx];
                }
...
}, window.GLIFFY_TEST_MCE_LATE_LOAD ? 2000 : 0)
